package com.example.admin.cosmos.widgt;
...
/**
 * Created by Michael Chen on 2016/12/28 13:35
 * 920901835@qq.com
 *
 *
 *    圆形头像
...
public class CircleImageView extends android.support.v7.widget.AppCompatImageView {
  ...
  public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
    ...
    mBorderColor = a.getColor(R.styleable.CircleImageView_border_color2, DEFAULT_BORDER_COLOR);
